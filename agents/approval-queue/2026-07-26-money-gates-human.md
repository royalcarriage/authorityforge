# Money gates (human only) — 2026-07-26
...
- Stream: affiliates
- 11 partners defined (Semrush, Ahrefs, …) but enabled:false and empty url. Cash path blocked until IDs pasted.
...
- **Ahrefs**: https://ahrefs.com/affiliate-program
...
- **Screaming Frog**: https://www.screamingfrog.co.uk/affiliate/
