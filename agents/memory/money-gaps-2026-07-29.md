...
- **P1** [agent] **Content queue depth 3 < 5** — Autonomous publish needs backlog of monetizable topics. → _Agent:_ Seed queue with commercial SEO/affiliate topics.
...
- (P1) monetization-chief: Grow data-aff CTAs (now ~132) on compare/tools/blog so IDs earn the day they're pasted
